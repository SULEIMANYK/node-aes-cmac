...
function aes(key, message) {
  ...
  console.log(keyLengthToCipher[key.length])
...
exports.aesCmac = function (key, message) {
  ...
  //}
  console.log( "lastBlock : " + lastBlock.toString("hex"))
  ...
  console.log( "final message y : " + y.toString("hex"))
  return aes(key, y);
};
